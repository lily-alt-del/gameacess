      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-end gap-12">
        ...
        <div className="flex flex-col gap-5 w-full md:w-auto md:items-end">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            ...
            <div className="flex items-center bg-[#52525b] rounded-full w-full md:w-72 border border-zinc-500 focus-within:border-purple-500 transition-colors" style={{ padding: '3px 10px' }}>
              <input 
                type="email" 
                placeholder="Email" 
