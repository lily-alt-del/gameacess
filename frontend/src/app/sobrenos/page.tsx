        ...
        <div className="w-full max-w-4xl">
          ...
          <section className="w-full mb-24 mt-10">
            ...
            <div className="space-y-8">
              <h1 className="text-4xl md:text-6xl font-black uppercase leading-tight tracking-tight font-anton">
                Jogar é para todos. <br/>
                <span className="text-purple-500">Sem exceções</span>
              </h1>
              <br />
              <div className="text-lg md:text-xl text-zinc-400 leading-relaxed max-w-3xl font-dyslexic">
                <p className="mb-6">
          ...
          <section className="w-full mt-24">
            <h2 className="text-4xl font-bold uppercase mb-16 flex items-center gap-4 font-dyslexic">
              Conheça nossos integrantes
              <div className="h-px bg-zinc-800 flex-1"></div>
            </h2>
            {/* Removi o grid e deixei flex-col para ficarem sempre um embaixo do outro */}
            <div className="flex flex-col gap-12 font-dyslexic" style={{ paddingBlock: 20 }}>
              {equipe.map((membro) => (
